...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, BasicBoxplotChartComponent, BasicBubbleChartComponent, BasicCandlestickChartComponent, BasicHeatmapChartComponent, BasicRangeAreaChartComponent, BasicScatterChartComponent, BasicTimelineChartComponent, BasicTreemapChartComponent],
