...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, BasicLineChartComponent, BrushLineChartComponent, DashedLineChartComponent, GradientLineChartComponent, SteplineLineChartComponent, SyncingLineChartComponent, ZoomableLineChartComponent],
