...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, BasicColumnChartComponent, DataLabelsColumnChartComponent, DistributedColumnChartComponent, RangeColumnChartComponent, RotatedLabelsColumnChartComponent, StackedColumnChartComponent],
