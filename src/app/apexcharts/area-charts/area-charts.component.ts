...
@Component({
    ...
    standalone: true,
    imports: [RouterLink, BasicAreaChartComponent, DatetimeAreaChartComponent, MissingNullValuesAreaChartComponent, SplineAreaChartComponent, StackedAreaChartComponent, NegativeValuesAreaChartComponent, GithubStyleAreaChartComponent],
