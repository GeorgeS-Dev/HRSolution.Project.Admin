...
const ELEMENT_DATA: PeriodicElement[] = [
    {
        card: {
            cardImg: 'images/icons/paypal.svg',
            cardNumber: '00***99',
    ...
    {
        card: {
            cardImg: 'images/icons/skrill.svg',
            cardNumber: '11***22',
    ...
    {
        card: {
            cardImg: 'images/icons/mastercard.svg',
            cardNumber: '77***88',
            cardType: 'Master Card'
        },
        date: '16 Jul, 2024',
